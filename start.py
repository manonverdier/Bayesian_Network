...
while ans:
    ...
    if ans=="4":
        ...
        if ans!='0'or (ans=='0'and config_defined=='y') :
            ...
            print "Please type the name of the Infile (.csv) and type the parameters you want to change. Type enter if you want to keep the default ones"
